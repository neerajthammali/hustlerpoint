...
const articles: Article[] = [
  {
    ...
    readingTime: 5,
    content: [
      'The debate between remote and in-office work has dominated conversations for the past two years. But as the dust settles, a new model is emerging as the clear winner: hybrid work.',
  ...
  },
  {
    ...
    readingTime: 7,
    content: [
      'The creator economy is no longer a niche industry; it\'s a global phenomenon valued at over $100 billion. From YouTubers to TikTokers, podcasters to newsletter writers, individuals are building empires from their bedrooms. But how do you go from a hobbyist to a professional creator?',
  ...
  },
  {
    ...
    readingTime: 6,
    content: [
        'For early-stage founders, the pitch deck is the single most important document. It\'s your first impression on potential investors, and it needs to be perfect. But a common mistake is to fill it with dry data and technical jargon. A great pitch deck is not a report; it\'s a story.',
